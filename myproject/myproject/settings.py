...
SECRET_KEY = 'django-insecure-3z4(rgd8w)qp^kt(2x67-w$ti0$z_3^w-8yedxy2hw^kim#=bg'
...
MIDDLEWARE = [
    ...
    'myproject.middleware.UserRedirectMiddleware',
]
...
DEFAULT_FROM_EMAIL = 'your_name@example.com' 
